...
> Preserved from the upstream project that this repository was forked from. The active multi-platform product lives at the repository root. The instructions below apply to the reMarkable implementation in this directory.
